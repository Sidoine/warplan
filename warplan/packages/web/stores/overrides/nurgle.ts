...
//     );
//     override(
//         data.extraAbilities.nurgleDaemonicBoonsTomeOfAThousandPoxes,
//         (x) => {
//             x.category = "artifact";
//             x.ability.description =
...
//     });
//     override(
//         data.extraAbilities.nurgleArtefactsOfContagionTheBileheart,
//         (x) => {
//             x.category = "artifact";
//             x.ability.description =
...
//     override(
//         data.extraAbilities.nurglePlagueriddenGiftsTheVirulentBlade,
//         (x) => {
//             x.category = "artifact";
//             x.ability.description =
...
//     );
//     override(
//         data.extraAbilities.nurglePlagueriddenGiftsTheFoetidShroud,
//         (x) => {
//             x.category = "artifact";
//             x.ability.description =
...
//     });
//     override(
//         data.extraAbilities.nurglePlagueriddenGiftsTheCarrionDirge,
//         (x) => {
//             x.category = "artifact";
//             x.ability.description =

...
@observer
export class BasketElementEdit extends React.Component<
    BasketElementEditProps,
    {}
> {
    render() {
        ...
        return (
            <tr>
                ...
                <td>
                    <IconButton
                        onClick={() =>
                            this.props.basketStore!.removeBasketElement(
                                this.props.basketElement
                            )
                        }
                    >
                        <DeleteIcon />
    ...
    private onCountChange = (value: number) => {
        this.props.basketStore!.setBasketElementCount(
            this.props.basketElement,
            value
        );
    };

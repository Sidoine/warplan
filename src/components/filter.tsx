...
export class Filter extends React.Component<FilterProps> {
    @computed get grandAlliance() {
        return (
            grandAlliances.find(
                x => x.value === this.props.uiStore!.grandAlliance
            ) || null
        );
    }
    render() {
        const factionOptions = this.props.unitsStore!.factionsList.filter(
                    ...
                    <Grid container wrap="wrap" spacing={2}>
                        ...
                        <Grid item>
                            <DropdownObjects
                                ...
                                value={this.grandAlliance}
                                onChange={this.setGrandAlliance}
                            />
                        </Grid>
                        <Grid item>
                            <DropdownObjects
                                ...
                                value={this.props.uiStore!.faction}
                                onChange={this.setFaction}
                            />
                        </Grid>
                        <Grid item>
                            <Input
                                value={this.props.uiStore!.keywordFilter}

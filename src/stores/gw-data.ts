...
let output = `import { WarscrollInterface, Battalion, Box, DataStore } from "./units";
...
for (const key in data) {
    const faction = data[key];
    let allModels: string[] = [];

    if (faction.heroes) {
        allModels = allModels.concat(faction.heroes.map(x => x.name));
    }
    if (faction.monsters) {
        allModels = allModels.concat(faction.monsters.map(x => x.name));
    }
    if (faction.warmachines) {
        allModels = allModels.concat(faction.warmachines.map(x => x.name));
    }

    for (const model of allModels) {
        output += `        ${toCamelCase(model)}: {
            id: this.serial++,
            name: "${model}"
        },
`;
...
for (const key in data) {
    ...
    if (faction.heroes) {
        allModels = allModels.concat(faction.heroes);
    }
    if (faction.monsters) {
        allModels = allModels.concat(faction.monsters);
    }
    if (faction.warmachines) {
        allModels = allModels.concat(faction.warmachines);
    }

    for (const model of allModels) {
        output += `        ${toCamelCase(model.name)}: {
            id: this.serial++,
            name: "${model}"
        },
`;
...
// $("#armiesDropDownList").empty(), "Chaos" === e ? (addToArmySelectionDropDown("Beastmen", "chaos", "BEASTMEN", ""), addToArmySelectionDropDown("Brayherd", "chaos", "BRAYHERD", ""), addToArmySelectionDropDown("Chaos Gargants", "chaos", "CHAOSGARGANTS", ""), addToArmySelectionDropDown("Clan Eshin", "chaos", "SKAVENESHIN", ""), addToArmySelectionDropDown("Clan Moulder", "chaos", "SKAVENMOULDER", ""), addToArmySelectionDropDown("Clan Pestilens", "chaos", "SKAVENPESTILENS", ""), addToArmySelectionDropDown("Clan Skryre", "chaos", "SKAVENSKRYRE", ""), addToArmySelectionDropDown("Clan Verminus", "chaos", "SKAVENVERMINUS", ""), addToArmySelectionDropDown("Daemons Of Chaos", "chaos", "DAEMONSOFCHAOS", ""), addToArmySelectionDropDown("Daemons Of Khorne", "chaos", "KHORNEDAEMONS", ""), addToArmySelectionDropDown("Daemons Of Nurgle", "chaos", "NURGLEDAEMONS", ""), addToArmySelectionDropDown("Daemons Of Tzeentch", "chaos", "TZEENTCHDAEMONS", ""), addToArmySelectionDropDown("Everchosen", "chaos", "EVERCHOSEN", ""), addToArmySelectionDropDown("Hosts Of Slaanesh", "chaos", "SLAANESHDAEMONS", ""), addToArmySelectionDropDown("Khorne Bloodbound", "chaos", "KHORNEBLOODBOUND", ""), addToArmySelectionDropDown("Legion Of Azgorh", "chaos", "LEGIONOFAZGORH", ""), addToArmySelectionDropDown("Masterclan", "chaos", "MASTERCLAN", ""), addToArmySelectionDropDown("Monsters Of Chaos", "chaos", "MONSTERSOFCHAOS", ""), addToArmySelectionDropDown("Nurgle Rotbringers", "chaos", "NURGLEROTBRINGERS", ""), addToArmySelectionDropDown("Slaves To Darkness", "chaos", "SLAVESTODARKNESS", ""), addToArmySelectionDropDown("Skaven", "chaos", "SKAVEN", ""), addToArmySelectionDropDown("Tamurkhan's Horde", "chaos", "TAMURKHANSHORDE", ""), addToArmySelectionDropDown("Thunderscorn", "chaos", "THUNDERSCORN", ""), addToArmySelectionDropDown("Tzeentch Arcanites", "chaos", "TZEENTCHARCHANITES", ""), addToArmySelectionDropDown("Warherd", "chaos", "WARHERD", ""), addToArmySelectionDropDown("Warriors of Chaos", "chaos", "WARRIORSOFCHAOS", "")) : "Order" === e ? (addToArmySelectionDropDown("Aelves", "order", "AELVES", ""), addToArmySelectionDropDown("Bretonnians", "order", "BRETONNIA", ""), addToArmySelectionDropDown("Collegiate Arcane", "order", "COLLEGIATEARCANE", ""), addToArmySelectionDropDown("Dark Elves", "order", "EXILES", ""), addToArmySelectionDropDown("Darkling Covens", "order", "DARKLINGCOVENS", ""), addToArmySelectionDropDown("Daughters Of Khaine", "order", "DAUGHTERSOFKHAINE", ""), addToArmySelectionDropDown("Devoted Of Sigmar", "order", "DEVOTEDOFSIGMAR", ""), addToArmySelectionDropDown("Dispossessed", "order", "DISPOSSESSED", ""), addToArmySelectionDropDown("Dwarfs", "order", "DWARFS", ""), addToArmySelectionDropDown("Eldritch Council", "order", "ELDRITCHCOUNCIL", ""), addToArmySelectionDropDown("Free Peoples", "order", "FREEPEOPLES", ""), addToArmySelectionDropDown("Fyreslayers", "order", "FYRESLAYERS", ""), addToArmySelectionDropDown("High Elves", "order", "HIGHELVES", ""), addToArmySelectionDropDown("Ironweld Arsenal", "order", "IRONWELDARSONAL", ""), addToArmySelectionDropDown("Kharadron Overlords", "order", "KHARADRONOVERLORDS", ""), addToArmySelectionDropDown("Lion Rangers", "order", "LIONRANGERS", ""), addToArmySelectionDropDown("Lizardmen", "order", "LIZARDMEN", ""), addToArmySelectionDropDown("Monsters Of Order", "order", "MONSTERSOFORDER", ""), addToArmySelectionDropDown("Order Draconis", "order", "ORDERDRACONIS", ""), addToArmySelectionDropDown("Order Serpentis", "order", "ORDERSERPENTIS", ""), addToArmySelectionDropDown("Phoenix Temple", "order", "PHOENIXTEMPLE", ""), addToArmySelectionDropDown("Scourge Privateers", "order", "SCOURGEPRIVATEERS", ""), addToArmySelectionDropDown("Seraphon", "order", "SERAPHON", ""), addToArmySelectionDropDown("Shadowblades", "order", "SHADOWBLADES", ""), addToArmySelectionDropDown("Stormcast Eternals", "order", "STORMCASTETERNALS", ""), addToArmySelectionDropDown("Swifthawk Agents", "order", "SWIFTHAWKAGENTS", ""), addToArmySelectionDropDown("Sylvaneth", "order", "SYLVANETH", ""), addToArmySelectionDropDown("The Empire", "order", "EMPIRE", ""), addToArmySelectionDropDown("Wanderers", "order", "WANDERERS", ""), addToArmySelectionDropDown("Wood Elves", "order", "WOODELVES", "")) : "Destruction" === e ? (addToArmySelectionDropDown("Aleguzzler Gargants", "destruction", "ALEGUZZLERGARGANTS", ""), addToArmySelectionDropDown("Beastclaw Raiders", "destruction", "BEASTCLAWRAIDERS", ""), addToArmySelectionDropDown("Bonesplitterz", "destruction", "BONESPLITTERZ", ""), addToArmySelectionDropDown("Firebellies", "destruction", "FIREBELLIES", ""), addToArmySelectionDropDown("Gitmob Grots", "destruction", "GROTS", ""), addToArmySelectionDropDown("Greenskinz", "destruction", "ORRUKS", ""), addToArmySelectionDropDown("Gutbusters", "destruction", "GUTBUSTERS", ""), addToArmySelectionDropDown("Ironjawz", "destruction", "IRONJAWZ", ""), addToArmySelectionDropDown("Maneaters", "destruction", "MANEATERS", ""), addToArmySelectionDropDown("Monsters Of Destruction", "destruction", "MONSTROUSARCANUM", ""), addToArmySelectionDropDown("Moonclan Grots", "destruction", "MOONCLANGROTS", ""), addToArmySelectionDropDown("Ogre Kingdoms", "destruction", "OGREKINGDOMS", ""), addToArmySelectionDropDown("Orcs & Goblins", "destruction", "ORCSANDGOBLINS", ""), addToArmySelectionDropDown("Spiderfang Grots", "destruction", "SPIDERFANGGROTS", ""), addToArmySelectionDropDown("Troggoths", "destruction", "TROGGOTHS", "")) : "Death" === e && (addToArmySelectionDropDown("Deadwalkers", "death", "DEADWALKERS", ""), addToArmySelectionDropDown("Deathlords", "death", "DEATHLORDS", ""), addToArmySelectionDropDown("Deathmages", "death", "DEATHMAGES", ""), addToArmySelectionDropDown("Deathrattle", "death", "DEATHRATTLE", ""), addToArmySelectionDropDown("Flesh Eater Courts", "death", "FLESHEATERCOURTS", ""), addToArmySelectionDropDown("Legions of Nagash", "death", "LEGIONSOFNAGASH", ""), addToArmySelectionDropDown("Nighthaunt", "death", "NIGHTHAUNT", ""), addToArmySelectionDropDown("Soulblight", "death", "SOULBLIGHT", ""), addToArmySelectionDropDown("Tomb Kings", "death", "TOMBKINGS", ""), addToArmySelectionDropDown("Vampire Counts", "death", "VAMPIRECOUNTS", "")), $("#armiesDropDownList li a").click(function(e) {

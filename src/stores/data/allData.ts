export function load(
    availablePoolArmies: any,
    realmArtefacts: any,
    alliesByAllegiance: any
) {
    function loadAllArmiesFaster() {
        ...
        var s =
                "Daemons of Nurgle Nurgle Rotbringers Slaves to Darkness Tamurkhan's Horde",
            e = "Khorne Bloodbound Daemons of Khorne Slaves to Darkness",
            o = "Hosts of Slaanesh Daemons of Slaanesh";
        (alliesByAllegiance.Brayherd =
            "Brayherd Chaos Gargants Monsters of Chaos Thunderscorn Warherds"),
            (alliesByAllegiance.Eshin =
            ...
            (alliesByAllegiance.Moulder =
                "Clan Eshin Clan Moulder Clan Pestilens Clan Skryre Clan Verminus Masterclan"),
            (alliesByAllegiance.Skryre =
                "Clan Eshin Clan Moulder Clan Pestilens Clan Skryre Clan Verminus Masterclan"),
            (alliesByAllegiance.Verminus =
                "Clan Eshin Clan Moulder Clan Pestilens Clan Skryre Clan Verminus Masterclan"),
            (alliesByAllegiance.Slaanesh =
                "Brayherd Chaos Gargants Everchosen Monsters of Chaos Warhderd" +
                s +
                o),
            (alliesByAllegiance.Khorne =
                "Khorne Brayherd Chaos Gargants Everchosen Monsters of Chaos Slaves To Darkness Warherd" +
                s +
                e),
            (alliesByAllegiance.Nurgle =
                "Brayherd Chaos Gargants Everchosen Monsters of Chaos Slaves To Darkness Warherd" +
                s +
                e +
                o),
            (alliesByAllegiance["Slaves To Darkness"] =
                "Brayherd Chaos Gargants Everchosen" +
                e +
                s +
                o +
                "Tzeentch Arcanites Daemons of TzeentchWarherd"),
            ...
            (availablePoolArmies.SLAVESTODARKNESS = {
                heroes: [
                    ...
                    { name: "Slambo", wounds: "5", desc: "", points: "1" },
                    {
                        name: "Daemon Prince",
                        wounds: "8",
                        desc: "",
            ...
            (availablePoolArmies.BRAYHERD = {
                heroes: [
                    { name: "Beastlord", wounds: "5", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.BRETONNIA = {
                heroes: [
                    ...
                    { name: "Damsel", wounds: "5", desc: "Wizard", points: "1" }
                ],
                units: [
                    {
                        name: "Knights Errant",
            ...
            (availablePoolArmies.DAUGHTERSOFKHAINE = {
                heroes: [
                    { name: "Hag Queen", wounds: "5", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.DISPOSSESSED = {
                heroes: [
                    { name: "Runelord", wounds: "5", desc: "", points: "1" },
                    { name: "Unforged", wounds: "5", desc: "", points: ".5" },
                    { name: "Warden King", wounds: "5", desc: "", points: ".5" }
                ],
                units: [
                    {
                        name: "Hammerers",
            ...
            (availablePoolArmies.DWARFS = {
                heroes: [
                    ...
                    { name: "Far-Ranger", wounds: "5", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.ELDRITCHCOUNCIL = {
                heroes: [
                    ...
                    { name: "Archmage", wounds: "5", desc: "", points: "1" },
                    {
                        name: "Loremaster",
                        wounds: "5",
                        desc: "",
                    ...
                    { name: "Drakeseer", wounds: "14", desc: "", points: "1.5" }
                ],
                units: [
                    {
                        name: "Swordmasters",
            ...
            (availablePoolArmies.EMPIRE = {
                heroes: [
                    { name: "Huntmarshal", wounds: "5", desc: "", points: "1" },
                    {
                ...
                monsters: [],
                warmachines: [
                    { name: "Greatcannon", wounds: "4", desc: "", points: "2" },
                    { name: "Field Mortar", wounds: "4", desc: "", points: "2" }
                ],
                formations: []
            }),
            ...
            (availablePoolArmies.EXILES = {
                heroes: [
                    { name: "Dreadlord", wounds: "5", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.FYRESLAYERS = {
                heroes: [
                    ...
                    { name: "Battlesmith", wounds: "6", desc: "", points: "1" },
                    {
                    ...
                    { name: "Fjul-Grimnir", wounds: "6", desc: "", points: "3" }
                ],
                units: [
                    {
            ...
            (availablePoolArmies.GUTBUSTERS = {
                heroes: [
                    { name: "Tyrant", wounds: "8", desc: "", points: "1" },
                    {
                        name: "Butcher",
                        wounds: "7",
                        desc: "Wizard",
            ...
            (availablePoolArmies.IRONWELDARSONAL = {
                heroes: [
                    { name: "Gunmaster", wounds: "5", desc: "", points: "1" },
                    { name: "Cogsmith", wounds: "5", desc: "", points: "1" }
                ],
                units: [],
                warmachines: [
                    {
                    ...
                    { name: "Cannon", wounds: "4", desc: "", points: "2" },
                    { name: "Organ Gun", wounds: "4", desc: "", points: "2" },
                    {
            ...
            (availablePoolArmies.KHORNEDAEMONS = {
                heroes: [
                    ...
                    { name: "Skulltaker", wounds: "5", desc: "", points: "1" },
                    {
                    ...
                    { name: "Karanak", wounds: "5", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.LEGIONOFAZGORH = {
                ...
                warmachines: [
                    ...
                    { name: "Magma Cannon", wounds: "6", desc: "", points: "2" }
                ],
                monsters: [
                    {
            ...
            (availablePoolArmies.MONSTERSOFCHAOS = {
                ...
                monsters: [
                    ...
                    { name: "Chimera", wounds: "12", desc: "", points: "2" },
                    {
                    ...
                    { name: "Cockatrice", wounds: "8", desc: "", points: "2" },
                    {
                        name: "Great Taurus",
                        wounds: "8",
                        desc: "",
                    ...
                    { name: "Lammasu", wounds: "8", desc: "", points: "2" },
                    { name: "Jabberslythe", wounds: "10", points: "2" },
                    { name: "Preyton", wounds: "8", desc: "", points: "1.5" },
                    {
            ...
            (availablePoolArmies.MONSTROUSARCANUM = {
                ...
                monsters: [
                    { name: "Basilisk", wounds: "10", desc: "", points: "2.5" },
                    {
                    ...
                    { name: "Dread Maw", wounds: "14", desc: "", points: "4" },
                    {
                    ...
                    { name: "Merwyrm", wounds: "12", desc: "", points: "3" },
                    { name: "Rogue Idol", wounds: "16", desc: "", points: "4" }
                ],
                warmachines: [
                    {
                        name: "Squig Gobba",
            ...
            (availablePoolArmies.NIGHTHAUNT = {
                ...
                warmachines: [],
                monsters: [
                    { name: "Mourngul", wounds: "10", desc: "", points: "3" }
                ],
                formations: []
            }),
            ...
            (availablePoolArmies.OGREKINGDOMS = {
                heroes: [
                    { name: "Overtyrant", wounds: "9", desc: "", points: "1" },
                    {
            ...
            (availablePoolArmies.ORCSANDGOBLINS = {
                heroes: [
                    ...
                    { name: "Gitboss", wounds: "4", desc: "", points: "1" },
                    { name: "Orruk Bully", wounds: "4", desc: "", points: ".5" }
                ],
                units: [
                    {
            ...
            (availablePoolArmies.ORDERSERPENTIS = {
                ...
                monsters: [
                    { name: "War Hydra", wounds: "12", desc: "", points: "2.5" }
                ],
                warmachines: [],
                formations: [
                    {
            ...
            (availablePoolArmies.PHOENIXTEMPLE = {
                heroes: [
                    ...
                    { name: "Anointed", wounds: "5", desc: "", points: "1" }
                ],
                units: [
                    {
                        name: "Phoenix Guard",
            ...
            (availablePoolArmies.SCOURGEPRIVATEERS = {
                ...
                monsters: [
                    { name: "Kharibdyss", wounds: "12", desc: "", points: "2" }
                ],
                warmachines: [],
                formations: [
                    {
            ...
            (availablePoolArmies.SERAPHON = {
                ...
                formations: [
                    ...
                    },
                    {
                        ...
                        points: "1",
                        units: [
                            { name: "Saurus Warriors", desc: "" },
                            { name: "Saurus Warriors", desc: "" },
                            { name: "Saurus Warriors", desc: "" }
                        ],
                        heroes: [{ name: "Saurus Sunblood", desc: "" }]
                    },
                    {
            ...
            (availablePoolArmies.SHADOWBLADES = {
                heroes: [
                    { name: "Assassin", wounds: "5", desc: "", points: "1" }
                ],
                units: [
                    {
                        name: "Dark Riders",
            ...
            (availablePoolArmies.SKAVENMOULDER = {
                heroes: [
                    { name: "Packmaster", wounds: "3", desc: "", points: ".5" }
                ],
                units: [
                    {
                        name: "Wolf Rats",
            ...
            (availablePoolArmies.SKAVENPESTILENS = {
                ...
                warmachines: [
                    { name: "Plagueclaw", wounds: "6", desc: "", points: "1.5" }
                ],
                monsters: [],
                formations: [
                    {
            ...
            (availablePoolArmies.SKAVENSKRYRE = {
                ...
                warmachines: [
                    { name: "Doomwheel", wounds: "8", desc: "", points: "2" },
                    {
            ...
            (availablePoolArmies.SWIFTHAWKAGENTS = {
                heroes: [
                    ...
                    { name: "Skywarden", wounds: "8", desc: "", points: "1.5" }
                ],
                units: [
                    {
                        name: "Reavers",
            ...
            (availablePoolArmies.TOMBKINGS = {
                heroes: [
                    ...
                    { name: "Tomb King", wounds: "6", desc: "", points: "1" },
                    {
                    ...
                    { name: "Necrotect", wounds: "5", desc: "", points: "1" },
                    {
                ...
                monsters: [
                    ...
                    { name: "Warsphinx", wounds: "12", desc: "", points: "3" },
                    { name: "Necrosphinx", wounds: "12", desc: "", points: "4" }
                ],
                formations: []
            }),
            ...
            (availablePoolArmies.WARHERD = {
                heroes: [
                    { name: "Doombull", wounds: "8", desc: "", points: "1.5" }
                ],
                units: [
                    {
                        name: "Bullgors",
                ...
                monsters: [
                    { name: "Cygor", wounds: "14", desc: "", points: "2" },
                    { name: "Ghorgon", wounds: "14", desc: "", points: "2.5" }
                ],
                formations: []
            }),
            (availablePoolArmies.WARRIORSOFCHAOS = {
                ...
                warmachines: [
                    { name: "Hellcannon", wounds: "10", desc: "", points: "3" }
                ],
                monsters: [],
                formations: []
            }),

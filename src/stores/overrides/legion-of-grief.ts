...
export function overrideLegionOfGrief(data: DataStoreImpl) {
    ...
    overrideAbility(
        ...
        x => {
            ...
            x.description =
                "If this general is on the battlefield, each time you spend a command point, roll a dice. On a 5+, you receive 1 extra command point.";
    ...
    overrideAbility(
        ...
        x => {
            ...
            x.description =
                'In your hero phase, you can inflict 1 mortal wound on 1 enemy HERO within 6" of the bearer, or you can heal 1 wound that has been allocated to the bearer.';
            x.effects = [
                {
                    targetType: TargetType.Enemy,
                    mortalWounds: 1,
    ...
    overrideAbility(
        ...
        x => {
            ...
            x.description =
                'Wail of Doom has a casting value of 8. If successfuly cast, roll a dice for each enemy unit within 6" of the caster. On a 4+ that unit suffers D3 mortal wounds.';
        }
    );
    overrideAbility(
    ...
    const theUnquietDead: Ability = {
        ...
        flavor:
            "The dead stir in every corner of the realms, rising up from unhallowed grave-pits and corpse-strewn battlefields to prey upon the living.",
        description:
    ...
    const deathlessMinions: Ability = {
        ...
        flavor:
            "The powerful death magic that binds the undead grows stronger when these minions are in close proximity of their masters.",
        description:
            'Roll a dice each time you allocate a wound or mortal wound to a friendly LEGION OF GRIEF unit within 6" of you general or another friendly LEGION OF GRIEF HERO. On a 6+ the wound or mortal wound is negated.',
        category: AbilityCategory.BattleTrait,
        effects: [
            {
                targetType: TargetType.Friend,
    ...
    const auraOfGrief: Ability = {
        ...
        name: "Aura of Grief",
        flavor:
            "To face the Legion of Grief in battle is to be overcome by waves of crushing sorrow.",
        description:
            'Subtract 1 from the Bravery characteristic of enemy units while they are within 6" of any friendly LEGION OF GRIEF units.',
        category: AbilityCategory.BattleTrait,
        effects: [
            {
                targetType: TargetType.Enemy,
    ...
    const endlessLegions: Ability = {
        ...
        flavor:
            "The souls of the deceased are innumerable, a bottomless well of sorrow and bitter hatred from which the lords of death magic can fashion their conquering armies.",
        description:
            'You can use this command ability at the end of your movement phase. If you do so, pick a gravesite (see \'The Unquiet Dead\') that is within 9" of your general, and then pick a friendly SUMMONABLE unit that has been destroyed. Set up that unit wholly within 9" of that gravesite and more than 9" from any enemy units.',

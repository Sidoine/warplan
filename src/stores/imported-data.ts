...
export class DataStoreImpl implements DataStore {
    ...
    units = {
        ...
        daemonPrince: {
            ...
            keywords: ["CHAOS", "SLAVES TO DARKNESS", "HERO", "DAEMON"],
            wounds: 8,
        ...
        daemonPrinceOfSlaanesh: {
            ...
            keywords: ["CHAOS", "SLAANESH", "HERO", "DAEMON"],
            wounds: 8,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aos-warscroll-chaos-daemonprince-en.pdf",
            isLeader: () => true,
            isBehemot: () => true,
        ...
        hagQueen: {
            ...
            keywords: ["ORDER", "DAUGHTERS OF KHAINE", "HERO"],
            wounds: 5,
            isLeader: () => true,
        },
        slaughterQueen: {
        ...
        verminlordCorruptor: {
            ...
            keywords: ["CHAOS", "SKAVEN PESTILENS", "HERO", "DAEMON", "WIZARD"],
            wounds: 12,
            isLeader: () => true,
            isBehemot: () => true,
        },
        ...
        exaltedGreaterDaemonOfTzeentch: {
            ...
            keywords: ["CHAOS", "TZEENTCH", "HERO", "DAEMON"],
            wounds: 20,
            isLeader: () => true,
            isBehemot: () => true,
        },

...
export class DataStoreImpl implements DataStore {
    ...
    units = {
        ...
        beastlord: {
            ...
            options: [{ name: "Man-ripper Axe & Brayshield", id: "manRipperAxeBrayshield", unitCategory: "main", modelCategory: "weapon" },{ name: "Pair of Man-ripper Axes", id: "pairOfManRipperAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Man-render Great Axe", id: "manRenderGreatAxe", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { manRipperAxeBrayshield: "manRipperAxeBrayshield", pairOfManRipperAxes: "pairOfManRipperAxes", manRenderGreatAxe: "manRenderGreatAxe" },
            isLeader: () => true,
        },
        bestigors: {
            id: "bestigors",
        ...
        gors: {
            ...
            options: [{ name: "Gor-Blades & Beastshields", id: "gorBladesBeastshields", unitCategory: "main", modelCategory: "weapon" },{ name: "Two Gor-Blades", id: "twoGorBlades", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { gorBladesBeastshields: "gorBladesBeastshields", twoGorBlades: "twoGorBlades" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "brayherd",
        },
        ungors: {
            id: "ungors",
            ...
            options: [{ name: "Mauls & Half-Shields", id: "maulsHalfShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Shortspears & Half-Shields", id: "shortspearsHalfShields", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { maulsHalfShields: "maulsHalfShields", shortspearsHalfShields: "shortspearsHalfShields" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "brayherd",
        },
        ungorRaiders: {
            id: "ungorRaiders",
        ...
        fleshHounds: {
            ...
            points: 100,
            type: "unit",
            subType: "Khorne Daemon - Khorne Battleline",
            keywords: ["CHAOS", "KHORNE", "DAEMON"],
            wounds: 2,
            maxSize: 20,
        ...
        heraldOfTzeentch: {
            ...
            wounds: 5,
            options: [{ name: "Staff of Change", id: "staffOfChange", unitCategory: "main", modelCategory: "weapon" },{ name: "Ritual Dagger", id: "ritualDagger", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { staffOfChange: "staffOfChange", ritualDagger: "ritualDagger" },
            isLeader: () => true,
        },
        heraldOfTzeentchOnBurningChariot: {
            id: "heraldOfTzeentchOnBurningChariot",
        ...
        aspiringDeathbringer: {
            ...
            options: [{ name: "Bloodaxe and Wrath Hammer", id: "bloodaxeAndWrathHammer", unitCategory: "main", modelCategory: "weapon" },{ name: "Goreaxe and Skullhammer", id: "goreaxeAndSkullhammer", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { bloodaxeAndWrathHammer: "bloodaxeAndWrathHammer", goreaxeAndSkullhammer: "goreaxeAndSkullhammer" },
            isLeader: () => true,
        },
        aspiringDeathbringerWithGoreaxeAndSkullhammer: {
            id: "aspiringDeathbringerWithGoreaxeAndSkullhammer",
        ...
        exaltedDeathbringer: {
            ...
            options: [{ name: "Ruinous Axe & Skullgouger", id: "ruinousAxeSkullgouger", unitCategory: "main", modelCategory: "weapon" },{ name: "Bloodbite Axe & Shield", id: "bloodbiteAxeShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ruinousAxeSkullgouger: "ruinousAxeSkullgouger", bloodbiteAxeShield: "bloodbiteAxeShield" },
            isLeader: () => true,
        },
        exaltedDeathbringerWithImpalingSpear: {
            id: "exaltedDeathbringerWithImpalingSpear",
        ...
        bloodWarriors: {
            ...
            options: [{ name: "Goreaxes", id: "goreaxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Goreaxe & Gorefist", id: "goreaxeGorefist", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { goreaxes: "goreaxes", goreaxeGorefist: "goreaxeGorefist" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "khorne",
        },
        bloodreavers: {
            id: "bloodreavers",
            ...
            options: [{ name: "Reaver Blades", id: "reaverBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Meatripper Axes", id: "meatripperAxes", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { reaverBlades: "reaverBlades", meatripperAxes: "meatripperAxes" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "khorne",
        },
        mightySkullcrushers: {
            id: "mightySkullcrushers",
            ...
            options: [{ name: "Ensorcelled Axes", id: "ensorcelledAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Bloodglaives", id: "bloodglaives", unitCategory: "main", modelCategory: "weapon" },{ name: "Axes", id: "axes", unitCategory: "main", modelCategory: "weapon" },{ name: "Glaives", id: "glaives", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ensorcelledAxes: "ensorcelledAxes", bloodglaives: "bloodglaives", axes: "axes", glaives: "glaives" },
        ...
        skullreapers: {
            ...
            options: [{ name: "Goreslick Blades", id: "goreslickBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Daemonblades", id: "daemonblades", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { goreslickBlades: "goreslickBlades", daemonblades: "daemonblades" },
        },
        wrathmongers: {
            id: "wrathmongers",
        ...
        doombull: {
            ...
            options: [{ name: "Pair of Axes", id: "pairOfAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Axe & Shield", id: "axeShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Axe", id: "greatAxe", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pairOfAxes: "pairOfAxes", axeShield: "axeShield", greatAxe: "greatAxe" },
            isLeader: () => true,
        },
        cygor: {
            id: "cygor",
        ...
        bullgors: {
            ...
            options: [{ name: "Pairs of Axes", id: "pairsOfAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Axes & Bullshields", id: "axesBullshields", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Axes", id: "greatAxes", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pairsOfAxes: "pairsOfAxes", axesBullshields: "axesBullshields", greatAxes: "greatAxes" },
            isBattleline: () => true,
        },
        hellcannon: {
            id: "hellcannon",
        ...
        daemonPrince: {
            ...
            options: [{ name: "Axe", id: "axe", unitCategory: "main", modelCategory: "weapon" },{ name: "Sword", id: "sword", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { axe: "axe", sword: "sword" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        soulGrinder: {
        ...
        festusTheLeechlord: {
            ...
            keywords: ["CHAOS", "NURGLE", "HERO", "WIZARD", "ROTBRINGER", "MORTAL"],
            wounds: 6,
        ...
        gutrotSpume: {
            ...
            keywords: ["CHAOS", "NURGLE", "HERO", "ROTBRINGER", "MORTAL"],
            wounds: 7,
        ...
        theGlottkin: {
            ...
            keywords: ["CHAOS", "NURGLE", "HERO", "WIZARD", "ROTBRINGER", "MORTAL", "MONSTER"],
            wounds: 18,
        ...
        sorceressOnBlackDragon: {
            ...
            options: [{ name: "Witch Rod", id: "witchRod", unitCategory: "main", modelCategory: "weapon" },{ name: "Sword of Ghrond", id: "swordOfGhrond", unitCategory: "main", modelCategory: "weapon" },{ name: "Darkling Sword", id: "darklingSword", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { witchRod: "witchRod", swordOfGhrond: "swordOfGhrond", darklingSword: "darklingSword" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        bloodwrackMedusa: {
        ...
        sistersOfSlaughter: {
            ...
            options: [{ name: "Barbed Whips and Sacrificial Knives", id: "barbedWhipsAndSacrificialKnives", unitCategory: "main", modelCategory: "weapon" },{ name: "Barbed Whips and Blade Bucklers", id: "barbedWhipsAndBladeBucklers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { barbedWhipsAndSacrificialKnives: "barbedWhipsAndSacrificialKnives", barbedWhipsAndBladeBucklers: "barbedWhipsAndBladeBucklers" },
        ...
        witchAelves: {
            ...
            options: [{ name: "Pairs of Sacrificial Knives", id: "pairsOfSacrificialKnives", unitCategory: "main", modelCategory: "weapon" },{ name: "Sacrificial Knives and Blade Bucklers", id: "sacrificialKnivesAndBladeBucklers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pairsOfSacrificialKnives: "pairsOfSacrificialKnives", sacrificialKnivesAndBladeBucklers: "sacrificialKnivesAndBladeBucklers" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "daughtersOfKhaine",
        },
        bloodStalkers: {
            id: "bloodStalkers",
        ...
        dreadlordOnBlackDragon: {
            ...
            wounds: 14,
            options: [{ name: "Exile Blade & Shield", id: "exileBladeShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Exile Blade & Repeater Crossbow", id: "exileBladeRepeaterCrossbow", unitCategory: "main", modelCategory: "weapon" },{ name: "Lance of Spite & Shield", id: "lanceOfSpiteShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Lance of Spite & Repeater Crossbow", id: "lanceOfSpiteRepeaterCrossbow", unitCategory: "main", modelCategory: "weapon" },{ name: "Exile Blades", id: "exileBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Exile Blade & Tyrant Shield", id: "exileBladeTyrantShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Lance of Spite & Tyrant Shield", id: "lanceOfSpiteTyrantShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { exileBladeShield: "exileBladeShield", exileBladeRepeaterCrossbow: "exileBladeRepeaterCrossbow", lanceOfSpiteShield: "lanceOfSpiteShield", lanceOfSpiteRepeaterCrossbow: "lanceOfSpiteRepeaterCrossbow", exileBlades: "exileBlades", exileBladeTyrantShield: "exileBladeTyrantShield", lanceOfSpiteTyrantShield: "lanceOfSpiteTyrantShield" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        drakespawnKnights: {
        ...
        blackArkCorsairs: {
            ...
            options: [{ name: "Vicious Blade & Repeater Handbow", id: "viciousBladeRepeaterHandbow", unitCategory: "main", modelCategory: "weapon" },{ name: "Vicious Blade & Wicked Cutlass", id: "viciousBladeWickedCutlass", unitCategory: "main", modelCategory: "weapon" },{ name: "Vicious Blades & Repeater Handbows", id: "viciousBladesRepeaterHandbows", unitCategory: "main", modelCategory: "weapon" },{ name: "Vicious Blades & Wicked Cutlasses", id: "viciousBladesWickedCutlasses", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { viciousBladeRepeaterHandbow: "viciousBladeRepeaterHandbow", viciousBladeWickedCutlass: "viciousBladeWickedCutlass", viciousBladesRepeaterHandbows: "viciousBladesRepeaterHandbows", viciousBladesWickedCutlasses: "viciousBladesWickedCutlasses" },
            isBattleline: () => true,
        },
        assassin: {
            id: "assassin",
        ...
        dreadlord: {
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Exile Blades", id: "exileBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Exile Blade & Tyrant Shield", id: "exileBladeTyrantShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Chillblade", id: "chillblade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { exileBlades: "exileBlades", exileBladeTyrantShield: "exileBladeTyrantShield", chillblade: "chillblade" },
            isLeader: () => true,
        },
        dreadlordOnDrakespawn: {
            id: "dreadlordOnDrakespawn",
        ...
        morghastArchai: {
            ...
            options: [{ name: "Spirit Swords", id: "spiritSwords", unitCategory: "main", modelCategory: "weapon" },{ name: "Spirit Halberds", id: "spiritHalberds", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { spiritSwords: "spiritSwords", spiritHalberds: "spiritHalberds" },
            isBattleline: () => true,
        },
        morghastHarbingers: {
            id: "morghastHarbingers",
        ...
        graveGuard: {
            ...
            options: [{ name: "Wight Blades & Crypt Shields", id: "wightBladesCryptShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Wight Blades", id: "greatWightBlades", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { wightBladesCryptShields: "wightBladesCryptShields", greatWightBlades: "greatWightBlades" },
            isBattleline: () => true,
        },
        wightKingWithBalefulTombBlade: {
            id: "wightKingWithBalefulTombBlade",
        ...
        skeletonWarriors: {
            ...
            options: [{ name: "Ancient Blades", id: "ancientBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Ancient Spears", id: "ancientSpears", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ancientBlades: "ancientBlades", ancientSpears: "ancientSpears" },
            isBattleline: () => true,
        },
        blackKnights: {
            id: "blackKnights",
        ...
        vampireLordOnZombieDragon: {
            ...
            options: [{ name: "Deathlance", id: "deathlance", unitCategory: "main", modelCategory: "weapon" },{ name: "Deathlance & Chalice", id: "deathlanceChalice", unitCategory: "main", modelCategory: "weapon" },{ name: "Deathlance & Shield", id: "deathlanceShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Deathlance & Shield & Chalice", id: "deathlanceShieldChalice", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword", id: "vampiricSword", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword & Chalice", id: "vampiricSwordChalice", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword & Shield", id: "vampiricSwordShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword & Shield & Chalice", id: "vampiricSwordShieldChalice", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { deathlance: "deathlance", deathlanceChalice: "deathlanceChalice", deathlanceShield: "deathlanceShield", deathlanceShieldChalice: "deathlanceShieldChalice", vampiricSword: "vampiricSword", vampiricSwordChalice: "vampiricSwordChalice", vampiricSwordShield: "vampiricSwordShield", vampiricSwordShieldChalice: "vampiricSwordShieldChalice" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        princeVhordrai: {
        ...
        legionBlackCoach: {
            id: "legionBlackCoach",
            model: this.models.legionBlackCoach,
            factions: [this.factions.LEGIONSOFNAGASH],
            size: 1,
            points: 120,
            type: "unit",
        ...
        longbeards: {
            ...
            options: [{ name: "Axes or Hammers", id: "axesOrHammers", unitCategory: "main", modelCategory: "weapon" },{ name: "Axes or Hammers & Shields", id: "axesOrHammersShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Axes", id: "greatAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Axes & Shields", id: "greatAxesShields", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { axesOrHammers: "axesOrHammers", axesOrHammersShields: "axesOrHammersShields", greatAxes: "greatAxes", greatAxesShields: "greatAxesShields" },
            isBattleline: () => true,
        },
        vulkiteBerzerkers: {
            id: "vulkiteBerzerkers",
            ...
            options: [{ name: "Handaxes & Slingshields", id: "handaxesSlingshields", unitCategory: "main", modelCategory: "weapon" },{ name: "War-Picks & Slingshields", id: "warPicksSlingshields", unitCategory: "main", modelCategory: "weapon" },{ name: "Pairs of Handaxes", id: "pairsOfHandaxes", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { handaxesSlingshields: "handaxesSlingshields", warPicksSlingshields: "warPicksSlingshields", pairsOfHandaxes: "pairsOfHandaxes" },
            isBattleline: () => true,
        },
        warriors: {
            id: "warriors",
            ...
            options: [{ name: "Axes or Hammers", id: "axesOrHammers", unitCategory: "main", modelCategory: "weapon" },{ name: "Axes or Hammers & Shields", id: "axesOrHammersShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Double-handed Duardin Axes", id: "doubleHandedDuardinAxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Double-handed Duardin Axes & Shields", id: "doubleHandedDuardinAxesShields", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { axesOrHammers: "axesOrHammers", axesOrHammersShields: "axesOrHammersShields", doubleHandedDuardinAxes: "doubleHandedDuardinAxes", doubleHandedDuardinAxesShields: "doubleHandedDuardinAxesShields" },
            isBattleline: () => true,
        },
        auricRunefatherOnMagmadroth: {
            id: "auricRunefatherOnMagmadroth",
        ...
        auricRunesmiterOnMagmadroth: {
            ...
            options: [{ name: "Runic Iron", id: "runicIron", unitCategory: "main", modelCategory: "weapon" },{ name: "Forge Key", id: "forgeKey", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { runicIron: "runicIron", forgeKey: "forgeKey" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        auricRunesonOnMagmadroth: {
            ...
            options: [{ name: "Ancestral War-axe", id: "ancestralWarAxe", unitCategory: "main", modelCategory: "weapon" },{ name: "Wyrmslayer Javelins", id: "wyrmslayerJavelins", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ancestralWarAxe: "ancestralWarAxe", wyrmslayerJavelins: "wyrmslayerJavelins" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        hearthguardBerzerkers: {
            ...
            options: [{ name: "Broadaxes", id: "broadaxes", unitCategory: "main", modelCategory: "weapon" },{ name: "Poleaxes", id: "poleaxes", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { broadaxes: "broadaxes", poleaxes: "poleaxes" },
            isBattleline: () => true,
        },
        auricHearthguard: {
            id: "auricHearthguard",
        ...
        freeguildGuard: {
            ...
            options: [{ name: "Halberds and Shields", id: "halberdsAndShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Spears and Shields", id: "spearsAndShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Swords and Shields", id: "swordsAndShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Militia Weapons", id: "militiaWeapons", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { halberdsAndShields: "halberdsAndShields", spearsAndShields: "spearsAndShields", swordsAndShields: "swordsAndShields", militiaWeapons: "militiaWeapons" },
            isBattleline: () => true,
        },
        freeguildHandgunners: {
            id: "freeguildHandgunners",
        ...
        freeguildGeneralOnGriffon: {
            ...
            options: [{ name: "Lance", id: "lance", unitCategory: "main", modelCategory: "weapon" },{ name: "Runesword", id: "runesword", unitCategory: "main", modelCategory: "weapon" },{ name: "Greathammer", id: "greathammer", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Lance", id: "shieldLance", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Runesword", id: "shieldRunesword", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Greathammer", id: "shieldGreathammer", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { lance: "lance", runesword: "runesword", greathammer: "greathammer", shieldLance: "shieldLance", shieldRunesword: "shieldRunesword", shieldGreathammer: "shieldGreathammer" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        luminarkOfHysh: {
        ...
        demigryphKnights: {
            ...
            options: [{ name: "Lance and Sword", id: "lanceAndSword", unitCategory: "main", modelCategory: "weapon" },{ name: "Cavalry Halberd", id: "cavalryHalberd", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { lanceAndSword: "lanceAndSword", cavalryHalberd: "cavalryHalberd" },
        ...
        freeguildGeneral: {
            ...
            wounds: 5,
            options: [{ name: "Stately War Banner", id: "statelyWarBanner", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Weapon", id: "greatWeapon", unitCategory: "main", modelCategory: "weapon" },{ name: "Pistol & Sigmarite Weapon", id: "pistolSigmariteWeapon", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Sigmarite Weapon", id: "shieldSigmariteWeapon", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Lance", id: "shieldLance", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { statelyWarBanner: "statelyWarBanner", greatWeapon: "greatWeapon", pistolSigmariteWeapon: "pistolSigmariteWeapon", shieldSigmariteWeapon: "shieldSigmariteWeapon", shieldLance: "shieldLance" },
            isLeader: () => true,
        },
        freeguildGreatswords: {
            id: "freeguildGreatswords",
        ...
        engineerOnMechanicalSteed: {
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Handgun", id: "handgun", unitCategory: "main", modelCategory: "weapon" },{ name: "Grenade Launching Blunderbuss", id: "grenadeLaunchingBlunderbuss", unitCategory: "main", modelCategory: "weapon" },{ name: "Repeater Handgun", id: "repeaterHandgun", unitCategory: "main", modelCategory: "weapon" },{ name: "Long Rifle", id: "longRifle", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { handgun: "handgun", grenadeLaunchingBlunderbuss: "grenadeLaunchingBlunderbuss", repeaterHandgun: "repeaterHandgun", longRifle: "longRifle" },
            isLeader: () => true,
        },
        warriorPriest: {
            id: "warriorPriest",
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Sigmarite Warhammers", id: "sigmariteWarhammers", unitCategory: "main", modelCategory: "weapon" },{ name: "Sigmarite Warhammer & Shield", id: "sigmariteWarhammerShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Sigmarite Greathammer", id: "sigmariteGreathammer", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { sigmariteWarhammers: "sigmariteWarhammers", sigmariteWarhammerShield: "sigmariteWarhammerShield", sigmariteGreathammer: "sigmariteGreathammer" },
            isLeader: () => true,
        },
        witchHunter: {
            id: "witchHunter",
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Pistols & Blessed Rapier", id: "pistolsBlessedRapier", unitCategory: "main", modelCategory: "weapon" },{ name: "Pistol & Silver Greatsword", id: "pistolSilverGreatsword", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pistolsBlessedRapier: "pistolsBlessedRapier", pistolSilverGreatsword: "pistolSilverGreatsword" },
            isLeader: () => true,
        },
        highbornRepeaterBoltThrower: {
            id: "highbornRepeaterBoltThrower",
        ...
        dragonlord: {
            ...
            keywords: ["ORDER", "HERO", "MONSTER"],
            wounds: 14,
            options: [{ name: "Shield & Dragon Blade", id: "shieldDragonBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Dragon Lance", id: "shieldDragonLance", unitCategory: "main", modelCategory: "weapon" },{ name: "Reaver Bow & Dragon Blade", id: "reaverBowDragonBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Reaver Bow & Dragon Lance", id: "reaverBowDragonLance", unitCategory: "main", modelCategory: "weapon" },{ name: "War Horn & Dragon Blade", id: "warHornDragonBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "War Horn & Dragon Lance", id: "warHornDragonLance", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { shieldDragonBlade: "shieldDragonBlade", shieldDragonLance: "shieldDragonLance", reaverBowDragonBlade: "reaverBowDragonBlade", reaverBowDragonLance: "reaverBowDragonLance", warHornDragonBlade: "warHornDragonBlade", warHornDragonLance: "warHornDragonLance" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        drakeseer: {
        ...
        archmageOnDragon: {
            ...
            keywords: ["ORDER", "HERO", "MONSTER"],
            wounds: 14,
            options: [{ name: "Magestaff", id: "magestaff", unitCategory: "main", modelCategory: "weapon" },{ name: "Magestaff & Book of Hoeth", id: "magestaffBookOfHoeth", unitCategory: "main", modelCategory: "weapon" },{ name: "Magestaff & Sword of Saphery", id: "magestaffSwordOfSaphery", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { magestaff: "magestaff", magestaffBookOfHoeth: "magestaffBookOfHoeth", magestaffSwordOfSaphery: "magestaffSwordOfSaphery" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        swordmasters: {
        ...
        skycutters: {
            ...
            wounds: 8,
            maxSize: 3,
            options: [{ name: "Swifthawk Bows", id: "swifthawkBows", unitCategory: "main", modelCategory: "weapon" },{ name: "Eagle Eye Bolt Thrower", id: "eagleEyeBoltThrower", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { swifthawkBows: "swifthawkBows", eagleEyeBoltThrower: "eagleEyeBoltThrower" },
        },
        skywarden: {
            id: "skywarden",
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 8,
            options: [{ name: "Zephyr Trident", id: "zephyrTrident", unitCategory: "main", modelCategory: "weapon" },{ name: "Swifthawk Pennant", id: "swifthawkPennant", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { zephyrTrident: "zephyrTrident", swifthawkPennant: "swifthawkPennant" },
            isLeader: () => true,
        },
        reavers: {
            id: "reavers",
        ...
        dragonNoble: {
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Phoenix Banner", id: "phoenixBanner", unitCategory: "main", modelCategory: "weapon" },{ name: "Starblade", id: "starblade", unitCategory: "main", modelCategory: "weapon" },{ name: "Enchanted Polearm", id: "enchantedPolearm", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Starblade", id: "shieldStarblade", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Enchanted Polearm", id: "shieldEnchantedPolearm", unitCategory: "main", modelCategory: "weapon" },{ name: "Reaver Bow & Starblade", id: "reaverBowStarblade", unitCategory: "main", modelCategory: "weapon" },{ name: "Reaver Bow & Enchanted Polearm", id: "reaverBowEnchantedPolearm", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { phoenixBanner: "phoenixBanner", starblade: "starblade", enchantedPolearm: "enchantedPolearm", shieldStarblade: "shieldStarblade", shieldEnchantedPolearm: "shieldEnchantedPolearm", reaverBowStarblade: "reaverBowStarblade", reaverBowEnchantedPolearm: "reaverBowEnchantedPolearm" },
            isLeader: () => true,
        },
        greatEagles: {
            id: "greatEagles",
        ...
        bullCentaurRenders: {
            ...
            maxSize: 12,
            maxPoints: 640,
            options: [{ name: "Scalding Hand Weapons", id: "scaldingHandWeapons", unitCategory: "main", modelCategory: "weapon" },{ name: "Scalding Hand Weapon & Spiteshield", id: "scaldingHandWeaponSpiteshield", unitCategory: "main", modelCategory: "weapon" },{ name: "Scalding Great Weapon", id: "scaldingGreatWeapon", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { scaldingHandWeapons: "scaldingHandWeapons", scaldingHandWeaponSpiteshield: "scaldingHandWeaponSpiteshield", scaldingGreatWeapon: "scaldingGreatWeapon" },
            isBattleline: () => true,
        },
        infernalGuardFireglaives: {
            id: "infernalGuardFireglaives",
        ...
        daemonsmith: {
            ...
            keywords: ["CHAOS", "HERO"],
            wounds: 5,
            options: [{ name: "Darkforged Weapon", id: "darkforgedWeapon", unitCategory: "main", modelCategory: "weapon" },{ name: "Pyre Rune Staff", id: "pyreRuneStaff", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { darkforgedWeapon: "darkforgedWeapon", pyreRuneStaff: "pyreRuneStaff" },
            isLeader: () => true,
        },
        infernalGuardBattleStandardBearer: {
            id: "infernalGuardBattleStandardBearer",
        ...
        infernalGuardCastellan: {
            ...
            keywords: ["CHAOS", "HERO"],
            wounds: 5,
            options: [{ name: "Darkforged Weapon & Spiteshield", id: "darkforgedWeaponSpiteshield", unitCategory: "main", modelCategory: "weapon" },{ name: "Darkforged Weapon & Pyrelock Pistol", id: "darkforgedWeaponPyrelockPistol", unitCategory: "main", modelCategory: "weapon" },{ name: "Darkforged Great Weapon", id: "darkforgedGreatWeapon", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { darkforgedWeaponSpiteshield: "darkforgedWeaponSpiteshield", darkforgedWeaponPyrelockPistol: "darkforgedWeaponPyrelockPistol", darkforgedGreatWeapon: "darkforgedGreatWeapon" },
            isLeader: () => true,
        },
        kDaaiFireborn: {
            id: "kDaaiFireborn",
        ...
        saurusWarriors: {
            ...
            options: [{ name: "Clubs", id: "clubs", unitCategory: "main", modelCategory: "weapon" },{ name: "Spears", id: "spears", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { clubs: "clubs", spears: "spears" },
            isBattleline: () => true,
        },
        skinks: {
            id: "skinks",
            ...
            options: [{ name: "Meteoric Javelins & Star Bucklers", id: "meteoricJavelinsStarBucklers", unitCategory: "main", modelCategory: "weapon" },{ name: "Boltspitters & Star Bucklers", id: "boltspittersStarBucklers", unitCategory: "main", modelCategory: "weapon" },{ name: "Boltspitters & Moonstone Clubs", id: "boltspittersMoonstoneClubs", unitCategory: "main", modelCategory: "weapon" },{ name: "Moonstone Clubs & Star bucklers", id: "moonstoneClubsStarBucklers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { meteoricJavelinsStarBucklers: "meteoricJavelinsStarBucklers", boltspittersStarBucklers: "boltspittersStarBucklers", boltspittersMoonstoneClubs: "boltspittersMoonstoneClubs", moonstoneClubsStarBucklers: "moonstoneClubsStarBucklers" },
        ...
        saurusScarVeteranOnCarnosaur: {
            ...
            options: [{ name: "Warblade", id: "warblade", unitCategory: "main", modelCategory: "weapon" },{ name: "War Spear", id: "warSpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatblade", id: "greatblade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { warblade: "warblade", warSpear: "warSpear", greatblade: "greatblade" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        stegadon: {
        ...
        skinkPriest: {
            ...
            options: [{ name: "Priestly Trappings", id: "priestlyTrappings", unitCategory: "main", modelCategory: "weapon" },{ name: "Cloak of Feathers", id: "cloakOfFeathers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { priestlyTrappings: "priestlyTrappings", cloakOfFeathers: "cloakOfFeathers" },
            isLeader: () => true,
        },
        skinkStarpriest: {
            id: "skinkStarpriest",
        ...
        saurusKnights: {
            ...
            options: [{ name: "Blades", id: "blades", unitCategory: "main", modelCategory: "weapon" },{ name: "Lances", id: "lances", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { blades: "blades", lances: "lances" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "seraphon",
        },
        saurusAstrolithBearer: {
            id: "saurusAstrolithBearer",
        ...
        saurusOldblood: {
            ...
            options: [{ name: "Suntooth Maul", id: "suntoothMaul", unitCategory: "main", modelCategory: "weapon" },{ name: "Warblade", id: "warblade", unitCategory: "main", modelCategory: "weapon" },{ name: "War Spear", id: "warSpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatblade", id: "greatblade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { suntoothMaul: "suntoothMaul", warblade: "warblade", warSpear: "warSpear", greatblade: "greatblade" },
            isLeader: () => true,
        },
        saurusScarVeteranOnColdOne: {
            id: "saurusScarVeteranOnColdOne",
        ...
        skinkChief: {
            ...
            wounds: 4,
            maxSize: 1,
            options: [{ name: "Golden Sickle", id: "goldenSickle", unitCategory: "main", modelCategory: "weapon" },{ name: "Ornate Club", id: "ornateClub", unitCategory: "main", modelCategory: "weapon" },{ name: "Golden Sickle & Blowpipe", id: "goldenSickleBlowpipe", unitCategory: "main", modelCategory: "weapon" },{ name: "Ornate Club & Blowpipe", id: "ornateClubBlowpipe", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { goldenSickle: "goldenSickle", ornateClub: "ornateClub", goldenSickleBlowpipe: "goldenSickleBlowpipe", ornateClubBlowpipe: "ornateClubBlowpipe" },
            isLeader: () => true,
        },
        skinkHandlers: {
            id: "skinkHandlers",
        ...
        terradonRiders: {
            ...
            options: [{ name: "Starstrike Javelins", id: "starstrikeJavelins", unitCategory: "main", modelCategory: "weapon" },{ name: "Sunleech Bolas", id: "sunleechBolas", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { starstrikeJavelins: "starstrikeJavelins", sunleechBolas: "sunleechBolas" },
        },
        squigGobba: {
            id: "squigGobba",
        ...
        frostlordOnThundertusk: {
            ...
            points: 420,
            type: "hero",
            subType: "Thundertusk Beastclaw Raiders - Behemoth",
            keywords: ["DESTRUCTION", "BEASTCLAW RAIDERS", "HERO", "MONSTER"],
            wounds: 13,
            isLeader: () => true,
            isBehemot: () => true,
        ...
        huskardOnStonehorn: {
            ...
            options: [{ name: "Chaintrap", id: "chaintrap", unitCategory: "main", modelCategory: "weapon" },{ name: "Harpoon Launcher", id: "harpoonLauncher", unitCategory: "main", modelCategory: "weapon" },{ name: "Blood Vulture", id: "bloodVulture", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { chaintrap: "chaintrap", harpoonLauncher: "harpoonLauncher", bloodVulture: "bloodVulture" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        huskardOnThundertusk: {
        ...
        mournfangPack: {
            ...
            options: [{ name: "Gargant Hackers", id: "gargantHackers", unitCategory: "main", modelCategory: "weapon" },{ name: "Culling Clubs or Prey Hackers with Iron Fists", id: "cullingClubsOrPreyHackersWithIronFists", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { gargantHackers: "gargantHackers", cullingClubsOrPreyHackersWithIronFists: "cullingClubsOrPreyHackersWithIronFists" },
        ...
        icefallYhetees: {
            ...
            points: 120,
            type: "unit",
            subType: "Beastclaw Raiders - Beastclaw Raiders Battleline (Thundertusk General)",
            keywords: ["DESTRUCTION", "BEASTCLAW RAIDERS"],
            wounds: 4,
            maxSize: 12,
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "beastclawRaiders" && wi.general && wi.general.unit.id === "thundertusk",
        },
        frostSabres: {
            id: "frostSabres",
        ...
        stonehornBeastriders: {
            ...
            options: [{ name: "Chaintrap", id: "chaintrap", unitCategory: "main", modelCategory: "weapon" },{ name: "Blood Vulture", id: "bloodVulture", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { chaintrap: "chaintrap", bloodVulture: "bloodVulture" },
            isBehemot: () => true,
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "beastclawRaiders",
        },
        thundertuskBeastriders: {
        ...
        tyrant: {
            ...
            options: [{ name: "Massive Ogor Club", id: "massiveOgorClub", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Gutgouger", id: "greatGutgouger", unitCategory: "main", modelCategory: "weapon" },{ name: "Pair of Clubs, Bashers or Slicers", id: "pairOfClubsBashersOrSlicers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { massiveOgorClub: "massiveOgorClub", greatGutgouger: "greatGutgouger", pairOfClubsBashersOrSlicers: "pairOfClubsBashersOrSlicers" },
            isLeader: () => true,
        },
        grotScraplauncher: {
            id: "grotScraplauncher",
        ...
        ogors: {
            ...
            options: [{ name: "Ogor Clubs or Blades with Iron Fists", id: "ogorClubsOrBladesWithIronFists", unitCategory: "main", modelCategory: "weapon" },{ name: "Pairs of Ogor Clubs or Blades", id: "pairsOfOgorClubsOrBlades", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ogorClubsOrBladesWithIronFists: "ogorClubsOrBladesWithIronFists", pairsOfOgorClubsOrBlades: "pairsOfOgorClubsOrBlades" },
            isBattleline: () => true,
        },
        leadbelchers: {
            id: "leadbelchers",
        ...
        savageBigBoss: {
            ...
            wounds: 6,
            options: [{ name: "Granite Choppas", id: "graniteChoppas", unitCategory: "main", modelCategory: "weapon" },{ name: "Granite Choppa & Shield", id: "graniteChoppaShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Stonecleava", id: "stonecleava", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { graniteChoppas: "graniteChoppas", graniteChoppaShield: "graniteChoppaShield", stonecleava: "stonecleava" },
            isLeader: () => true,
        },
        savageBigStabbas: {
            id: "savageBigStabbas",
        ...
        gitmobGrots: {
            ...
            maxSize: 60,
            maxPoints: 270,
            options: [{ name: "Spears & Shields", id: "spearsShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Bows & Slashas", id: "bowsSlashas", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { spearsShields: "spearsShields", bowsSlashas: "bowsSlashas" },
            isBattleline: () => true,
        },
        grotWolfRiders: {
            id: "grotWolfRiders",
            ...
            maxSize: 30,
            maxPoints: 480,
            options: [{ name: "Slittas & Wolf Bows", id: "slittasWolfBows", unitCategory: "main", modelCategory: "weapon" },{ name: "Shields & Slittas & Wolf Bows", id: "shieldsSlittasWolfBows", unitCategory: "main", modelCategory: "weapon" },{ name: "Pokin Spears", id: "pokinSpears", unitCategory: "main", modelCategory: "weapon" },{ name: "Shields & Pokin Spears", id: "shieldsPokinSpears", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { slittasWolfBows: "slittasWolfBows", shieldsSlittasWolfBows: "shieldsSlittasWolfBows", pokinSpears: "pokinSpears", shieldsPokinSpears: "shieldsPokinSpears" },
            isBattleline: () => true,
        },
        orrukBoarChariots: {
            id: "orrukBoarChariots",
        ...
        orrukWarboss: {
            ...
            keywords: ["DESTRUCTION", "HERO"],
            wounds: 6,
            options: [{ name: "Boss Choppas", id: "bossChoppas", unitCategory: "main", modelCategory: "weapon" },{ name: "Boss Choppa & Shield", id: "bossChoppaShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Massive Choppa", id: "massiveChoppa", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Waaagh Banner", id: "greatWaaaghBanner", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { bossChoppas: "bossChoppas", bossChoppaShield: "bossChoppaShield", massiveChoppa: "massiveChoppa", greatWaaaghBanner: "greatWaaaghBanner" },
            isLeader: () => true,
        },
        orruks: {
            id: "orruks",
            ...
            maxSize: 40,
            maxPoints: 280,
            options: [{ name: "Pair of Choppas", id: "pairOfChoppas", unitCategory: "main", modelCategory: "weapon" },{ name: "Choppas & Shields", id: "choppasShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Pigstikka Spears & Shields", id: "pigstikkaSpearsShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Bows & Cuttas", id: "bowsCuttas", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pairOfChoppas: "pairOfChoppas", choppasShields: "choppasShields", pigstikkaSpearsShields: "pigstikkaSpearsShields", bowsCuttas: "bowsCuttas" },
            isBattleline: () => true,
        },
        orrukBoarboys: {
            id: "orrukBoarboys",
        ...
        grotWarboss: {
            ...
            keywords: ["DESTRUCTION", "HERO"],
            wounds: 4,
            options: [{ name: "Git Cuttas", id: "gitCuttas", unitCategory: "main", modelCategory: "weapon" },{ name: "Git Cutta & Git Shield", id: "gitCuttaGitShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Git Slicer", id: "gitSlicer", unitCategory: "main", modelCategory: "weapon" },{ name: "Pair of Moon Cuttas", id: "pairOfMoonCuttas", unitCategory: "main", modelCategory: "weapon" },{ name: "Moon Cutta & Git Shield", id: "moonCuttaGitShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Moon Slicer", id: "moonSlicer", unitCategory: "main", modelCategory: "weapon" },{ name: "Moon Prodder & Giant Cave Squig", id: "moonProdderGiantCaveSquig", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { gitCuttas: "gitCuttas", gitCuttaGitShield: "gitCuttaGitShield", gitSlicer: "gitSlicer", pairOfMoonCuttas: "pairOfMoonCuttas", moonCuttaGitShield: "moonCuttaGitShield", moonSlicer: "moonSlicer", moonProdderGiantCaveSquig: "moonProdderGiantCaveSquig" },
            isLeader: () => true,
        },
        grotWarbossOnGreatCaveSquig: {
            id: "grotWarbossOnGreatCaveSquig",
            ...
            keywords: ["DESTRUCTION", "HERO"],
            wounds: 6,
            options: [{ name: "Moon Cutta & Git Shield", id: "moonCuttaGitShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Night Stabba & Git Shield", id: "nightStabbaGitShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { moonCuttaGitShield: "moonCuttaGitShield", nightStabbaGitShield: "nightStabbaGitShield" },
            isLeader: () => true,
        },
        moonclanGrotShaman: {
            id: "moonclanGrotShaman",
        ...
        moonclanGrots: {
            ...
            maxSize: 60,
            maxPoints: 360,
            options: [{ name: "Pokin Spears & Moon Shields", id: "pokinSpearsMoonShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Stabbas & Moon Shields", id: "stabbasMoonShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Bows & Slittas", id: "bowsSlittas", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { pokinSpearsMoonShields: "pokinSpearsMoonShields", stabbasMoonShields: "stabbasMoonShields", bowsSlittas: "bowsSlittas" },
            isBattleline: () => true,
        },
        manglerSquigs: {
            id: "manglerSquigs",
        ...
        wildwoodRangers: {
            ...
            wounds: 1,
            maxSize: 30,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aos-warscroll-wildwood-rangers-en.pdf",
        ...
        spellweaver: {
            ...
            keywords: ["ORDER", "WANDERERS", "HERO"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aos-warscroll-spellweaver-en.pdf",
            options: [{ name: "Heartwood Staff", id: "heartwoodStaff", unitCategory: "main", modelCategory: "weapon" },{ name: "Blows of Mystic Power", id: "blowsOfMysticPower", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { heartwoodStaff: "heartwoodStaff", blowsOfMysticPower: "blowsOfMysticPower" },
            isLeader: () => true,
        },
        wayfinder: {
            id: "wayfinder",
            ...
            keywords: ["ORDER", "WANDERERS", "HERO"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aos-warscroll-wayfinder-en.pdf",
            isLeader: () => true,
        },
        waystrider: {
            id: "waystrider",
        ...
        gladeLord: {
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 5,
            options: [{ name: "Kindred Blade & Starlight Spear", id: "kindredBladeStarlightSpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Bow of Loren & Starlight Greatblade", id: "bowOfLorenStarlightGreatblade", unitCategory: "main", modelCategory: "weapon" },{ name: "Bow of Loren & Hunting Falcon", id: "bowOfLorenHuntingFalcon", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { kindredBladeStarlightSpear: "kindredBladeStarlightSpear", bowOfLorenStarlightGreatblade: "bowOfLorenStarlightGreatblade", bowOfLorenHuntingFalcon: "bowOfLorenHuntingFalcon" },
            isLeader: () => true,
        },
        gladeLordOnGreatEagle: {
            id: "gladeLordOnGreatEagle",
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 7,
            options: [{ name: "Bow of Loren", id: "bowOfLoren", unitCategory: "main", modelCategory: "weapon" },{ name: "Spirit Blade", id: "spiritBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { bowOfLoren: "bowOfLoren", spiritBlade: "spiritBlade" },
            isLeader: () => true,
        },
        gladeLordOnGreatStag: {
            id: "gladeLordOnGreatStag",
            ...
            keywords: ["ORDER", "HERO"],
            wounds: 7,
            options: [{ name: "Normal", id: "normal", unitCategory: "main", modelCategory: "weapon" },{ name: "Bow of Loren", id: "bowOfLoren", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { normal: "normal", bowOfLoren: "bowOfLoren" },
            isLeader: () => true,
        },
        huntingHounds: {
            id: "huntingHounds",
        ...
        skavenAssassin: {
            ...
            keywords: ["CHAOS", "HERO"],
            wounds: 5,
            options: [{ name: "Weeping Blades", id: "weepingBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Fighting Claws", id: "fightingClaws", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { weepingBlades: "weepingBlades", fightingClaws: "fightingClaws" },
            isLeader: () => true,
        },
        nightRunners: {
            id: "nightRunners",
        ...
        thanquolAndBoneripper: {
            ...
            keywords: ["CHAOS", "HERO", "MONSTER"],
            wounds: 13,
            options: [{ name: "Warpfire Projectors", id: "warpfireProjectors", unitCategory: "main", modelCategory: "weapon" },{ name: "Warpfire Braziers", id: "warpfireBraziers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { warpfireProjectors: "warpfireProjectors", warpfireBraziers: "warpfireBraziers" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        giantRats: {
        ...
        packmaster: {
            ...
            keywords: ["CHAOS", "HERO"],
            wounds: 3,
            options: [{ name: "Herding Whip & Blade", id: "herdingWhipBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Herding Whip & Thing Catcher", id: "herdingWhipThingCatcher", unitCategory: "main", modelCategory: "weapon" },{ name: "Shock-Prod", id: "shockProd", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { herdingWhipBlade: "herdingWhipBlade", herdingWhipThingCatcher: "herdingWhipThingCatcher", shockProd: "shockProd" },
            isLeader: () => true,
        },
        ratOgors: {
            id: "ratOgors",
        ...
        plagueMonks: {
            ...
            maxSize: 40,
            maxPoints: 240,
            options: [{ name: "Foetid Blades", id: "foetidBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Woe-stave", id: "woeStave", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { foetidBlades: "foetidBlades", woeStave: "woeStave" },
            isBattleline: () => true,
        },
        plagueFurnace: {
            id: "plagueFurnace",
        ...
        skavenWarlord: {
            ...
            keywords: ["CHAOS", "HERO"],
            wounds: 5,
            options: [{ name: "Warpforged Blade", id: "warpforgedBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "War Halberd", id: "warHalberd", unitCategory: "main", modelCategory: "weapon" },{ name: "Pair of Barbed Blades", id: "pairOfBarbedBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Barbed Blade", id: "barbedBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Warpforged Blade", id: "shieldWarpforgedBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & War Halberd", id: "shieldWarHalberd", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Pair of Barbed Blades", id: "shieldPairOfBarbedBlades", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Barbed Blade", id: "shieldBarbedBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { warpforgedBlade: "warpforgedBlade", warHalberd: "warHalberd", pairOfBarbedBlades: "pairOfBarbedBlades", barbedBlade: "barbedBlade", shieldWarpforgedBlade: "shieldWarpforgedBlade", shieldWarHalberd: "shieldWarHalberd", shieldPairOfBarbedBlades: "shieldPairOfBarbedBlades", shieldBarbedBlade: "shieldBarbedBlade" },
            isLeader: () => true,
        },
        stormvermin: {
            id: "stormvermin",
            ...
            maxSize: 40,
            maxPoints: 500,
            options: [{ name: "Halberd", id: "halberd", unitCategory: "main", modelCategory: "weapon" },{ name: "Halberd & Shield", id: "halberdShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { halberd: "halberd", halberdShield: "halberdShield" },
            isBattleline: () => true,
        },
        clanrats: {
            id: "clanrats",
            ...
            maxSize: 40,
            maxPoints: 200,
            options: [{ name: "Rusty Spear", id: "rustySpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Rusty Blade", id: "rustyBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { rustySpear: "rustySpear", rustyBlade: "rustyBlade" },
            isBattleline: () => true,
        },
        verminlordWarbringer: {
            id: "verminlordWarbringer",
        ...
        skavenslaves: {
            ...
            keywords: ["CHAOS"],
            wounds: 1,
            options: [{ name: "Sling", id: "sling", unitCategory: "main", modelCategory: "weapon" },{ name: "Rusty Spear", id: "rustySpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Rusty Blade", id: "rustyBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Rusty Spear", id: "shieldRustySpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Shield & Rusty Blade", id: "shieldRustyBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { sling: "sling", rustySpear: "rustySpear", rustyBlade: "rustyBlade", shieldRustySpear: "shieldRustySpear", shieldRustyBlade: "shieldRustyBlade" },
        },
        deathrunner: {
            id: "deathrunner",
        ...
        liberators: {
            ...
            options: [{ name: "Warhammers", id: "warhammers", unitCategory: "main", modelCategory: "weapon" },{ name: "Warblades", id: "warblades", unitCategory: "main", modelCategory: "weapon" },{ name: "Warhammer & Shield", id: "warhammerShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Warblade & Shield", id: "warbladeShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { warhammers: "warhammers", warblades: "warblades", warhammerShield: "warhammerShield", warbladeShield: "warbladeShield" },
            isBattleline: () => true,
        },
        drakeswornTemplar: {
            id: "drakeswornTemplar",
            ...
            wounds: 16,
            options: [{ name: "Tempest Axe", id: "tempestAxe", unitCategory: "main", modelCategory: "weapon" },{ name: "Arc Hammer", id: "arcHammer", unitCategory: "main", modelCategory: "weapon" },{ name: "Storm Lance", id: "stormLance", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { tempestAxe: "tempestAxe", arcHammer: "arcHammer", stormLance: "stormLance" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        lordCelestantOnStardrake: {
            ...
            options: [{ name: "Celestine Hammer", id: "celestineHammer", unitCategory: "main", modelCategory: "weapon" },{ name: "Stormbound Blade", id: "stormboundBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { celestineHammer: "celestineHammer", stormboundBlade: "stormboundBlade" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        judicators: {
            ...
            options: [{ name: "Skybolt Bows", id: "skyboltBows", unitCategory: "main", modelCategory: "weapon" },{ name: "Boltstorm Crossbows", id: "boltstormCrossbows", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { skyboltBows: "skyboltBows", boltstormCrossbows: "boltstormCrossbows" },
        ...
        knightVexillor: {
            ...
            options: [{ name: "Meteoric Standard", id: "meteoricStandard", unitCategory: "main", modelCategory: "weapon" },{ name: "Pennant of the Stormbringer", id: "pennantOfTheStormbringer", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { meteoricStandard: "meteoricStandard", pennantOfTheStormbringer: "pennantOfTheStormbringer" },
            isLeader: () => true,
        },
        celestantPrime: {
            id: "celestantPrime",
        ...
        lordCelestantOnDracoth: {
            ...
            options: [{ name: "Tempestos Hammer & Thundershield", id: "tempestosHammerThundershield", unitCategory: "main", modelCategory: "weapon" },{ name: "Lightning Hammer", id: "lightningHammer", unitCategory: "main", modelCategory: "weapon" },{ name: "Lightning Hammer & Thundershield", id: "lightningHammerThundershield", unitCategory: "main", modelCategory: "weapon" },{ name: "Stormstrike Glaive", id: "stormstrikeGlaive", unitCategory: "main", modelCategory: "weapon" },{ name: "Stormstrike Glaive & Thundershield", id: "stormstrikeGlaiveThundershield", unitCategory: "main", modelCategory: "weapon" },{ name: "Thunderaxe", id: "thunderaxe", unitCategory: "main", modelCategory: "weapon" },{ name: "Thunderaxe & Thundershield", id: "thunderaxeThundershield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { tempestosHammerThundershield: "tempestosHammerThundershield", lightningHammer: "lightningHammer", lightningHammerThundershield: "lightningHammerThundershield", stormstrikeGlaive: "stormstrikeGlaive", stormstrikeGlaiveThundershield: "stormstrikeGlaiveThundershield", thunderaxe: "thunderaxe", thunderaxeThundershield: "thunderaxeThundershield" },
            isLeader: () => true,
        },
        lordRelictor: {
            id: "lordRelictor",
        ...
        kurnothHunters: {
            ...
            options: [{ name: "Scythes", id: "scythes", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatswords", id: "greatswords", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatbows", id: "greatbows", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { scythes: "scythes", greatswords: "greatswords", greatbows: "greatbows" },
        },
        spiteRevenants: {
            id: "spiteRevenants",
        ...
        chaosWarMammoth: {
            ...
            type: "monster",
            subType: "Behemoth",
            keywords: ["CHAOS", "SLAVES TO DARKNESS", "MONSTER"],
            wounds: 22,
            isBehemot: () => true,
        },
        giganticChaosSpawn: {
        ...
        royalWarsphinx: {
            ...
            keywords: ["DEATH", "HERO", "MONSTER"],
            wounds: 12,
            options: [{ name: "Venom Spike Tail", id: "venomSpikeTail", unitCategory: "main", modelCategory: "weapon" },{ name: "Bladed Tail", id: "bladedTail", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { venomSpikeTail: "venomSpikeTail", bladedTail: "bladedTail" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        skeletonArchers: {
        ...
        tombGuard: {
            ...
            wounds: 1,
            maxSize: 30,
            options: [{ name: "Tomb Blade", id: "tombBlade", unitCategory: "main", modelCategory: "weapon" },{ name: "Bronze Halberd", id: "bronzeHalberd", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { tombBlade: "tombBlade", bronzeHalberd: "bronzeHalberd" },
        },
        tombHerald: {
            id: "tombHerald",
        ...
        tombKing: {
            ...
            keywords: ["DEATH", "HERO"],
            wounds: 6,
            options: [{ name: "Dynastic Blade & Shield", id: "dynasticBladeShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Monarch's Great Blade", id: "monarchSGreatBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { dynasticBladeShield: "dynasticBladeShield", monarchSGreatBlade: "monarchSGreatBlade" },
            isLeader: () => true,
        },
        tombKingInRoyalChariot: {
            id: "tombKingInRoyalChariot",
        ...
        ushabti: {
            ...
            wounds: 4,
            maxSize: 12,
            options: [{ name: "Ritual Blade Stave", id: "ritualBladeStave", unitCategory: "main", modelCategory: "weapon" },{ name: "Great Bow", id: "greatBow", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ritualBladeStave: "ritualBladeStave", greatBow: "greatBow" },
        },
        necromancerOnNightmare: {
            id: "necromancerOnNightmare",
        ...
        vampireLordOnAbyssalTerror: {
            ...
            keywords: ["DEATH", "HERO"],
            wounds: 8,
            options: [{ name: "Deathlance", id: "deathlance", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword", id: "vampiricSword", unitCategory: "main", modelCategory: "weapon" },{ name: "Deathlance & Shield", id: "deathlanceShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Vampiric Sword & Shield", id: "vampiricSwordShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { deathlance: "deathlance", vampiricSword: "vampiricSword", deathlanceShield: "deathlanceShield", vampiricSwordShield: "vampiricSwordShield" },
            isLeader: () => true,
        },
        chaosChariots: {
            id: "chaosChariots",
            ...
            wounds: 7,
            maxSize: 3,
            options: [{ name: "Greatblades", id: "greatblades", unitCategory: "main", modelCategory: "weapon" },{ name: "War flails", id: "warFlails", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { greatblades: "greatblades", warFlails: "warFlails" },
        ...
        chaosGorebeastChariots: {
            ...
            keywords: ["CHAOS", "SLAVES TO DARKNESS", "MORTAL"],
            wounds: 8,
            options: [{ name: "War Flail", id: "warFlail", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatblade", id: "greatblade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { warFlail: "warFlail", greatblade: "greatblade" },
        },
        darkoathChieftain: {
            id: "darkoathChieftain",
        ...
        chaosMarauders: {
            ...
            maxSize: 40,
            maxPoints: 200,
            options: [{ name: "Axes", id: "axes", unitCategory: "main", modelCategory: "weapon" },{ name: "Flails", id: "flails", unitCategory: "main", modelCategory: "weapon" },{ name: "Axes & Shields", id: "axesShields", unitCategory: "main", modelCategory: "weapon" },{ name: "Flails & Shields", id: "flailsShields", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { axes: "axes", flails: "flails", axesShields: "axesShields", flailsShields: "flailsShields" },
            isBattleline: () => true,
        },
        chaosWarriors: {
            id: "chaosWarriors",
            ...
            maxSize: 30,
            maxPoints: 480,
            options: [{ name: "Hand Weapon & Shield", id: "handWeaponShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Halberd & Shield", id: "halberdShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Hand Weapons", id: "handWeapons", unitCategory: "main", modelCategory: "weapon" },{ name: "Greatblade", id: "greatblade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { handWeaponShield: "handWeaponShield", halberdShield: "halberdShield", handWeapons: "handWeapons", greatblade: "greatblade" },
            isBattleline: () => true,
        },
        chaosKnights: {
            id: "chaosKnights",
            ...
            options: [{ name: "Ensorcelled Weapons", id: "ensorcelledWeapons", unitCategory: "main", modelCategory: "weapon" },{ name: "Chaos Glaives", id: "chaosGlaives", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ensorcelledWeapons: "ensorcelledWeapons", chaosGlaives: "chaosGlaives" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "slavesToDarkness",
        },
        chaosMarauderHorsemen: {
            id: "chaosMarauderHorsemen",
            ...
            maxSize: 30,
            maxPoints: 480,
            options: [{ name: "Axes & Shield", id: "axesShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Flails & Shield", id: "flailsShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Javelin & Shield", id: "javelinShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { axesShield: "axesShield", flailsShield: "flailsShield", javelinShield: "javelinShield" },
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "slavesToDarkness",
        },
        chaosLordOnManticore: {
            id: "chaosLordOnManticore",
            ...
            wounds: 12,
            options: [{ name: "Blade & Lance", id: "bladeLance", unitCategory: "main", modelCategory: "weapon" },{ name: "Flail & Lance", id: "flailLance", unitCategory: "main", modelCategory: "weapon" },{ name: "Blade & Runeshield", id: "bladeRuneshield", unitCategory: "main", modelCategory: "weapon" },{ name: "Flail & Runeshield", id: "flailRuneshield", unitCategory: "main", modelCategory: "weapon" },{ name: "Blade & Daggerfist", id: "bladeDaggerfist", unitCategory: "main", modelCategory: "weapon" },{ name: "Flail & Daggerfist", id: "flailDaggerfist", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { bladeLance: "bladeLance", flailLance: "flailLance", bladeRuneshield: "bladeRuneshield", flailRuneshield: "flailRuneshield", bladeDaggerfist: "bladeDaggerfist", flailDaggerfist: "flailDaggerfist" },
            isLeader: () => true,
            isBehemot: () => true,
        },
        chaosWarshrine: {
        ...
        chaosSorcererLord: {
            ...
            wounds: 5,
            options: [{ name: "Runestaff", id: "runestaff", unitCategory: "main", modelCategory: "weapon" },{ name: "Runesword", id: "runesword", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { runestaff: "runestaff", runesword: "runesword" },
            isLeader: () => true,
        },
        chaosSorcererLordOnManticore: {
            id: "chaosSorcererLordOnManticore",
        ...
        dragonOgors: {
            ...
            wounds: 5,
            maxSize: 12,
            options: [{ name: "Ancient Weapons", id: "ancientWeapons", unitCategory: "main", modelCategory: "weapon" },{ name: "Draconic War-glaives", id: "draconicWarGlaives", unitCategory: "main", modelCategory: "weapon" },{ name: "Draconic Crushers", id: "draconicCrushers", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ancientWeapons: "ancientWeapons", draconicWarGlaives: "draconicWarGlaives", draconicCrushers: "draconicCrushers" },
            isBattleline: () => true,
        },
        varanguard: {
            id: "varanguard",
            ...
            wounds: 5,
            maxSize: 12,
            options: [{ name: "Ensorcelled Weapon", id: "ensorcelledWeapon", unitCategory: "main", modelCategory: "weapon" },{ name: "Fellspear", id: "fellspear", unitCategory: "main", modelCategory: "weapon" },{ name: "Daemonforged Blade", id: "daemonforgedBlade", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { ensorcelledWeapon: "ensorcelledWeapon", fellspear: "fellspear", daemonforgedBlade: "daemonforgedBlade" },
            isBattleline: () => true,
        },
        chaosLordOfSlaanesh: {
            id: "chaosLordOfSlaanesh",
        ...
        hellstridersOfSlaanesh: {
            ...
            wounds: 2,
            maxSize: 20,
            options: [{ name: "Claw spear", id: "clawSpear", unitCategory: "main", modelCategory: "weapon" },{ name: "Hellscourge", id: "hellscourge", unitCategory: "main", modelCategory: "weapon" },{ name: "Claw spear & Shield", id: "clawSpearShield", unitCategory: "main", modelCategory: "weapon" },{ name: "Hellscourge & Shield", id: "hellscourgeShield", unitCategory: "main", modelCategory: "weapon" }],
            baseOptions: { clawSpear: "clawSpear", hellscourge: "hellscourge", clawSpearShield: "clawSpearShield", hellscourgeShield: "hellscourgeShield" },
        ...
        morbidexTwiceborn: {
            ...
            keywords: ["CHAOS", "NURGLE", "HERO", "ROTBRINGER", "MORTAL", "MONSTER"],
            wounds: 12,
        ...
        harbingerOfDecay: {
            ...
            keywords: ["CHAOS", "NURGLE", "HERO", "DAEMON", "ROTBRINGER", "MORTAL"],
            wounds: 7,
        ...
        aetherKhemist: {
            ...
            move: 4,
            save: "4+",
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aether-khemist_ENG.pdf",
            isLeader: () => true,
        },
        aethericNavigator: {
            id: "aethericNavigator",
            ...
            move: 4,
            save: "3+",
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/aetheric-navigator_ENG.pdf",
            isLeader: () => true,
        },
        arkanautAdmiral: {
            id: "arkanautAdmiral",
            ...
            move: 4,
            save: "3+",
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/arkanaut-admiral_ENG.pdf",
            isLeader: () => true,
        },
        arkanautCompany: {
            id: "arkanautCompany",
            ...
            wounds: 1,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/arkanaut-company_ENG.pdf",
            isBattleline: () => true,
        },
        arkanautFrigate: {
            id: "arkanautFrigate",
            ...
            wounds: 14,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/arkanaut-frigate_ENG.pdf",
            isBehemot: () => true,
        },
        arkanautIronclad: {
            id: "arkanautIronclad",
            ...
            keywords: ["ORDER", "KHARADRON OVERLORDS", "MONSTER"],
            wounds: 18,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/arkanaut-ironclad_ENG.pdf",
            isBehemot: () => true,
        },
        brokkGrungsson: {
            id: "brokkGrungsson",
            ...
            move: 12,
            save: "3+",
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/brokk-grungsson_ENG.pdf",
            isLeader: () => true,
        },
        endrinmaster: {
            id: "endrinmaster",
            ...
            move: 4,
            save: "4+",
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/endrinmaster_ENG.pdf",
            isLeader: () => true,
        },
        endrinriggers: {
            id: "endrinriggers",
            ...
            keywords: ["ORDER", "KHARADRON OVERLORDS"],
            wounds: 2,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/endrinriggers_ENG.pdf",
        },
        grundstokGunhauler: {
            id: "grundstokGunhauler",
            ...
            keywords: ["ORDER", "KHARADRON OVERLORDS"],
            wounds: 10,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/grundstok-gunhauler_ENG.pdf",
            isArtillery: () => true,
        },
        grundstokThunderers: {
            id: "grundstokThunderers",
            ...
            keywords: ["ORDER", "KHARADRON OVERLORDS"],
            wounds: 1,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/grunstok-thunderers_ENG.pdf",
        },
        skywardens: {
            id: "skywardens",
            ...
            keywords: ["ORDER", "KHARADRON OVERLORDS"],
            wounds: 2,
            warscroll: "https://www.games-workshop.com/resources/PDF/AoS_Warscrolls/skywardens_ENG.pdf",
        },
        khorgosKhul: {
            id: "khorgosKhul",
        ...
        akhelianLeviadon: {
            ...
            wounds: 16,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Akhelian_Leviadon.pdf",
            isBehemot: () => true,
        },
        vulturnosHighKingOfTheDeep: {
            id: "vulturnosHighKingOfTheDeep",
        ...
        akhelianAllopexes: {
            ...
            wounds: 8,
            maxSize: 4,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Akhelian_Allopexes.pdf",
        },
        akhelianIshlaenGuard: {
            id: "akhelianIshlaenGuard",
            ...
            wounds: 4,
            maxSize: 12,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Akhelian_Ishlaen_Guard.pdf",
        ...
        akhelianMorrsarrGuard: {
            ...
            wounds: 4,
            maxSize: 12,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Akhelian_Morrsarr_Guard.pdf",
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "idonethDeepkin" && wi.general && wi.general.unit.id === "akhelian",
        },
        namartiReavers: {
            id: "namartiReavers",
        ...
        lordArcanumOnGryphCharger: {
            ...
            points: 240,
            type: "hero",
            subType: "Lord Arcanum Wizard",
            keywords: ["ORDER", "STORMCAST ETERNALS", "HERO", "WIZARD"],
            wounds: 7,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Lord_Arcanum_Stormcast_2018.pdf",
            isLeader: () => true,
        },
        knightIncantor: {
            id: "knightIncantor",
            ...
            keywords: ["ORDER", "STORMCAST ETERNALS", "HERO", "WIZARD"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Knight_Incantor_Stormcast_2018.pdf",
            isLeader: () => true,
        },
        evocators: {
            id: "evocators",
            ...
            wounds: 3,
            maxSize: 20,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Evocators_Stormcast_2018.pdf",
        },
        castigators: {
            id: "castigators",
            ...
            wounds: 2,
            maxSize: 18,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Castigators_Stromcast_2018.pdf",
        },
        sequitors: {
            id: "sequitors",
            ...
            points: 120,
            type: "unit",
            subType: "Stormcast Eternals Battleline (Lord Arcanum General)",
            keywords: ["ORDER", "STORMCAST ETERNALS"],
            wounds: 2,
            maxSize: 20,
            maxPoints: 400,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Sequitors_Stormcast_2018.pdf",
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "stormcastEternals" && wi.general && wi.general.unit.id === "lordArcanum",
        },
        celestarBallista: {
            id: "celestarBallista",
            ...
            keywords: ["ORDER", "STORMCAST ETERNALS"],
            wounds: 7,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Celestar_Ballista_Stromcast_2018.pdf",
            isArtillery: () => true,
        },
        knightOfShroudsOnEtherealSteed: {
            id: "knightOfShroudsOnEtherealSteed",
            ...
            keywords: ["DEATH", "NIGHTHAUNT", "HERO"],
            wounds: 6,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_knight_of_shrouds_knighthaunt_2018.pdf",
            isLeader: () => true,
        },
        lordExecutioner: {
            id: "lordExecutioner",
            ...
            keywords: ["DEATH", "NIGHTHAUNT", "HERO"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Lord_Executioner_Nighthaunt_2018.pdf",
            isLeader: () => true,
        },
        guardianOfSoulsWithNightmareLantern: {
            id: "guardianOfSoulsWithNightmareLantern",
            ...
            type: "hero",
            subType: "Wizard",
            keywords: ["DEATH", "NIGHTHAUNT", "HERO", "WIZARD"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Guardian_of_Souls_Nighthaunt_2018.pdf",
            isLeader: () => true,
        },
        spiritTorment: {
            id: "spiritTorment",
            ...
            keywords: ["DEATH", "NIGHTHAUNT", "HERO"],
            wounds: 5,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Spirit_Torment_Nighthaunt_2018.pdf",
            isLeader: () => true,
        },
        grimghastReapers: {
            id: "grimghastReapers",
            ...
            points: 140,
            type: "unit",
            subType: "Nighthaunt Battleline",
            keywords: ["DEATH", "NIGHTHAUNT"],
            wounds: 1,
            maxSize: 30,
            maxPoints: 360,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Grimghast_Reapers_Nighthaunt_2018.pdf",
            isBattleline: (wi: WarscrollInterface) => wi.allegiance.id === "nighthaunt",
        },
        glaivewraithStalkers: {
            id: "glaivewraithStalkers",
            ...
            wounds: 1,
            maxSize: 16,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Glaivewraith_Stalkers_Nighthaunt_2018.pdf",
        },
        chainraspHorde: {
            id: "chainraspHorde",
            ...
            maxSize: 40,
            maxPoints: 280,
            warscroll: "https://www.games-workshop.com/resources/PDF/Downloads//ENG_Chainrasp_Horde_Nighthaunt_2018.pdf",
            isBattleline: () => true,
        },
        mazarallTheButcher: {
            id: "mazarallTheButcher",
    ...
    extraAbilities = {
        ...
        stormcastEternalsTreasuredStandardArtefactNone: {
            id: "stormcastEternalsTreasuredStandardArtefactNone",
            ability: { name: "None", description: "" },
            category: "Treasured Standard (Artefact)",
            isAvailable: keywordAvailable("Treasured Standard (Artefact)", "STORMCAST ETERNALS", ["KNIGHT-VEXILLOR"])
        },
        stormcastEternalsTreasuredStandardArtefactHurricaneBanner: {
            id: "stormcastEternalsTreasuredStandardArtefactHurricaneBanner",
            ability: { name: "Hurricane Banner", description: "" },
            category: "Treasured Standard (Artefact)",
            isAvailable: keywordAvailable("Treasured Standard (Artefact)", "STORMCAST ETERNALS", ["KNIGHT-VEXILLOR"])
        },
        stormcastEternalsTreasuredStandardArtefactLicheboneStandard: {
            id: "stormcastEternalsTreasuredStandardArtefactLicheboneStandard",
            ability: { name: "Lichebone Standard", description: "" },
            category: "Treasured Standard (Artefact)",
            isAvailable: keywordAvailable("Treasured Standard (Artefact)", "STORMCAST ETERNALS", ["KNIGHT-VEXILLOR"])
        },
        stormcastEternalsTreasuredStandardArtefactPennantOfSigmaron: {
            id: "stormcastEternalsTreasuredStandardArtefactPennantOfSigmaron",
        ...
        stormcastEternalsMysticLightArtefactNone: {
            id: "stormcastEternalsMysticLightArtefactNone",
            ability: { name: "None", description: "" },
            category: "Mystic Light (Artefact)",
            isAvailable: keywordAvailable("Mystic Light (Artefact)", "STORMCAST ETERNALS", ["LORD-CASTELLANT", "LORD-VERITANT", "KNIGHT-AZYROS"])
        },
        stormcastEternalsMysticLightArtefactShrivingLight: {
            id: "stormcastEternalsMysticLightArtefactShrivingLight",
            ability: { name: "Shriving Light", description: "" },
            category: "Mystic Light (Artefact)",
            isAvailable: keywordAvailable("Mystic Light (Artefact)", "STORMCAST ETERNALS", ["LORD-CASTELLANT", "LORD-VERITANT", "KNIGHT-AZYROS"])
        },
        stormcastEternalsMysticLightArtefactFuryBrand: {
            id: "stormcastEternalsMysticLightArtefactFuryBrand",
            ability: { name: "Fury Brand", description: "" },
            category: "Mystic Light (Artefact)",
            isAvailable: keywordAvailable("Mystic Light (Artefact)", "STORMCAST ETERNALS", ["LORD-CASTELLANT", "LORD-VERITANT", "KNIGHT-AZYROS"])
        },
        stormcastEternalsMysticLightArtefactLanternOfTheTempest: {
            id: "stormcastEternalsMysticLightArtefactLanternOfTheTempest",
        ...
        khorneBloodboundBannerOfKhorneArtefactNone: {
            id: "khorneBloodboundBannerOfKhorneArtefactNone",
            ability: { name: "None", description: "" },
            category: "Banner of Khorne (Artefact)",
            isAvailable: keywordAvailable("Banner of Khorne (Artefact)", "KHORNE BLOODBOUND", ["BLOODSECRATOR"])
        },
        khorneBloodboundBannerOfKhorneArtefactBannerOfRage: {
            id: "khorneBloodboundBannerOfKhorneArtefactBannerOfRage",
            ability: { name: "Banner of Rage", description: "" },
            category: "Banner of Khorne (Artefact)",
            isAvailable: keywordAvailable("Banner of Khorne (Artefact)", "KHORNE BLOODBOUND", ["BLOODSECRATOR"])
        },
        khorneBloodboundBannerOfKhorneArtefactBannerOfWrath: {
            id: "khorneBloodboundBannerOfKhorneArtefactBannerOfWrath",
            ability: { name: "Banner of Wrath", description: "" },
            category: "Banner of Khorne (Artefact)",
            isAvailable: keywordAvailable("Banner of Khorne (Artefact)", "KHORNE BLOODBOUND", ["BLOODSECRATOR"])
        },
        khorneBloodboundBannerOfKhorneArtefactBannerOfBlood: {
            id: "khorneBloodboundBannerOfKhorneArtefactBannerOfBlood",
